...
<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="admin-403-page no-slider">
                <div class="p-6 text-gray-900 align-middle">
                    <div class="flex flex-col items-center justify-center w-screen h-screen gap-12 py-8 text-center ">
